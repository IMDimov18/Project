...
namespace Kondio.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            return View(await _context.Users.Where(m=>m.IsActive== true).ToListAsync());
        }

        // GET: Users
        public async Task<IActionResult> InActive()
        {
            return View(await _context.Users.Where(m => m.IsActive == false).ToListAsync());
        }
